  ...
  return (
    <div className="space-y-10 sm:space-y-14">
      ...
      <section className="relative isolate overflow-hidden rounded-2xl border border-amber-900/40 bg-gradient-to-br from-[#0a0a0a] via-black to-amber-950/30 p-5 sm:rounded-3xl sm:p-8 md:p-12">
        ...
        {/*
          Mobile: single column, normal paint order (pin must not cover Live Forge).
          Desktop: pin sits in the right column with mild elevation only at lg+.
        */}
        ...
        {/* Own stacking layer so pin never paints over Live Forge on mobile */}
        <div className="relative z-0 mt-8 clear-both sm:mt-10">
