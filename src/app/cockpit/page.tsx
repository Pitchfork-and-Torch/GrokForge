  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <Badge>Creator OS</Badge>
          <h1 className="font-display mt-2 text-3xl font-bold text-[var(--foreground)]">Cockpit</h1>
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <Card>
          ...
          <p className="font-display text-2xl font-bold tabular-nums text-[var(--foreground)]">
            {projects.length}
          </p>
        </Card>
        <Card>
        ...
        <Card>
          ...
          <p className="font-display text-2xl font-bold tabular-nums text-[var(--success)]">
            {totalReady}
          </p>
        </Card>
      </div>
